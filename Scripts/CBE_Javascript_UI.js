...
var Subwindows_Active = [];
function Subwindows_Open(ID) {
  var Sound = new Audio("Assets/Sounds/SL_Sound_Click_3.mp3");
  if (Subwindows_Active.length == 0) {
    Element_Attribute_Set("Subwindows", "State", "Active");
  }
  Subwindows_Active.push(ID);
  Element_Attribute_Set(ID, "State", "Active");
  Sound.play();
}

function Subwindows_Close(ID) {
  var Sound = new Audio("Assets/Sounds/SL_Sound_Click_2.mp3");
  Subwindows_Active.splice(Subwindows_Active.indexOf(ID), 1);
  if (Subwindows_Active == 0) {
    Element_Attribute_Set("Subwindows", "State", "Inactive");
  }
